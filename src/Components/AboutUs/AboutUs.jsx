      ...
      <div className="max-w-7xl mx-auto grid lg:flex justify-between flex-row">
        ...
        <div className="lg:w-1/2 xl:pl-[150px] lg:pl-[100px] text-center lg:text-left">
          <p
            ...
            className="w-[100px] mx-auto lg:mx-0 text-center text-[#FF4800] uppercase font-semibold py-3 px-[6px] rounded-full"
          >
            About Us
          </p>
          <p className="text-3xl font-bold  py-6 text-black lg:mb-[20px] ">
          ...
          <button className="bg-[#FF4800] text-[20px] text-white py-[18px] px-[32px] border-none rounded-md">
            Create Account{" "}
          </button>
        </div>
      </div>
